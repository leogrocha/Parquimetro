...
insert into tb_registro (duracao_desejada, forma_pagamento, periodo_estacionamento, condutor_id, veiculo_id, inicio_registro, tarifa_aplicada, valor_total) values (null, 'CARTAO_CREDITO', 'POR_HORA', 1,1, now(), 2, 4);
